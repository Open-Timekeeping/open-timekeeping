...
- Trait signatures, function names, or other implementation API surface (→ the respective contract crate: [`otk-contracts`](../otk-contracts), [`EventIngestPort`](../timing-core/src/ports/outbound/ingest.rs) in `timing_core::ports::outbound`, [`EventLog`](../timing-core/src/ports/outbound/event_log.rs) in `timing_core::ports::outbound`, [`ingest-protocol`](../ingest-protocol)).
